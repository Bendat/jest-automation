...
To start configuring `jest-automation`, create a file near the root of your project called `automation.setup.ts` (or any name of your choosing) and add it to `jest.config.[j|t]s` as a [setup file](https://jestjs.io/docs/configuration#setupfilesafterenv-array).
